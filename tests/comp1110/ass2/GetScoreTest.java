...
public class GetScoreTest {
    ...
    public void testSimpleTwoPlayer() {
        for (int i = 0; i < comp1110.ass2.Utilities.PARTIAL_ADVANCED_SCORE_BOARDS.length; i++) {
            String boardString = comp1110.ass2.Utilities.PARTIAL_ADVANCED_SCORE_BOARDS[i];
            int[] expected = comp1110.ass2.Utilities.PARTIAL_ADVANCED_SCORES[i];
    ...
    public void testSimpleMultiplayer() {
        int[] players = {3, 4, 5, 6};
        for (int i = 0; i < comp1110.ass2.Utilities.PARTIAL_MULTIPLAYER_BOARDS.length; i++) {
            String boardString = comp1110.ass2.Utilities.PARTIAL_MULTIPLAYER_BOARDS[i];
            int[] expected = comp1110.ass2.Utilities.PARTIAL_MULTIPLAYER_SCORES[i];
